...
```{r}
library(tidyverse)
captures <- read_csv("data_raw/capture_raw.csv")
microsite <- read_csv("data_raw/microsite_raw.csv")
joined_data <- read_csv("data_raw/joined_data.csv")
microsite_grouped <- read_csv("data_raw/microsite_grouped_veg.csv")
erin <- read_csv("data_raw/Data_forErin_R.csv") # looks like counts per genus
```
